    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
                ...
                <div class="sidebar-brand-text mx-3">RestaurantApp</div>
            </a>
            ...
            <li class="nav-item {{ Request::is('especialidads*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('especialidads.index') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>especialidads</span></a>
            </li>
            ...
            <li class="nav-item {{ Request::is('reseñas*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('reseñas.index') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>reseñas</span></a>
            </li>
                    ...
                    <form method="get"
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-primary" id='search-btn' name="search" type="submit">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; RestaurantApp 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
