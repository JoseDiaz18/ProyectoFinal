<div class="table-responsive">
    <table class="table" id="promociones-table">
        ...
        @foreach($promociones as $promociones)
            ...
            <td>{{ $promociones->valor_descuento }}</td>
            <td>{{ $promociones->id_user_restaurante }}</td>
            <td>{{ $promociones->id_menu }}</td>
                <td>
                    {!! Form::open(['route' => ['promociones.destroy', $promociones->id], 'method' => 'delete']) !!}
                    <div class='btn-group'>
